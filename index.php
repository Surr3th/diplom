...
include 'profile/login_func.php';
?>
<!DOCTYPE html>
<html lang="ru">
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/chief-slider.css">
    ...
    <header>
        <div class="flexcontainer">
            ...
            <div class="main_flexbox">
                <a class="footer_info_company dan" href="../Diplom/pages/offers.php">Спецпредложения</a>
                <a class="footer_info_company dan" href="../Diplom/pages/info.php">О компании</a>
                <a class="footer_info_company dan" href="../Diplom/pages/rules.php">Правила для пассажиров</a>
            </div>
            <?php
            login_on();
            ?>
    ...
    <main>
        <div class="main_brat">
            <div class="little_brat">
                <h2 class="h2_brat">Поиск билетов</h2>
                <form class="form_brat" method="POST">
                    ...
                    <input type="date" name="search_date" class="search_date" id="button-search-username" min="2022-06-10" max="2022-06-20">
                    ...
                    <label for="tabs_date">Обратно</label>
                    <input type="date" name="search_date_return" class="search_date" id="button-search-username" min="2022-06-10" max="2022-06-20">
                    <input type="submit" name="button_search" class="button_search table-open" id="button-search-username" value="Найти">
                </form>
                <?php
                if (isset($_POST['button_search']) && input_search($_POST['search_depart'],$_POST['search_arrive'],$_POST['search_date'])) {
                    global $pdo;
                    $inputSearch1 = $_POST['search_depart'];
                    $inputSearch2 = $_POST['search_arrive'];
                    $inputSearch3 = $_POST['search_date'];
                    $inputSearch4= $_POST['search_date_return'];
                    $tickets = array();
                    $tickets2 = array();
                        foreach ($pdo->query("SELECT * FROM tickets WHERE depart = '$inputSearch1' AND arrive = '$inputSearch2' AND date='" . $inputSearch3 . "'") as $row4) {
                            array_push($tickets, $row4['id']);
                        };
                        for ($i = 0; $i < count($tickets); $i++) {
                            ...
                            echo '
                                ...
                                <div class="table">
                                <h3 class="table_title">' . $value['depart'] . ' - ' . $value['arrive'] . '</h2>
                        ...
                        if (isset($_POST['button_return_search'])) {
                            foreach ($pdo->query("SELECT * FROM tickets WHERE depart = '$inputSearch2'AND date='$inputSearch4' AND arrive = '" . $inputSearch1 . "' order by id") as $row5) {
                ...
                // if (input_search($_POST['search_depart'],$_POST['search_arrive'],$_POST['search_date']) == false) {
    ...
    <footer>
        <div class="footer_flexcontainer">
            ...
            <div class="footer_info_flexbox">
                ...
                <a class="footer_info_company dan" href="../Diplom/pages/info.php">О компании</a>
                <a class="footer_info_company dan" href="../Diplom/pages/policity.php">Политика конфиденциальности</a>
                <a class="footer_info_company dan" href="../Diplom/pages/rules.php">Грузовые перевозки</a>
            </div>
        </div>
    </footer>
